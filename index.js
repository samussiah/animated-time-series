(function (global, factory) {
    ...
    function layout$1(measure, key) {
        ...
        pieChart.g = addElement('pie-chart__g', pieChart.svg, 'g')
            .attr(
                'transform',
                'translate('
                    .concat(this.settings.widthPieChart / 2, ',')
                    .concat(this.settings.height / 2, ')')
            )
            .attr('text-anchor', 'middle');
        return {
            main: main,
    ...
    function xAxis(measure) {
        ...
        return measure.containers.xAxis
            ...
            .call(function (g) {
                return g
                    .append('text')
                    .attr('x', (_this.settings.widthTimeSeries - _this.settings.margin.left) / 2)
        ...
        return measure.containers.yAxis
            ...
            .call(function (g) {
                return g
                    ...
                    .attr(
                        'x2',
                        _this.settings.widthTimeSeries -
    ...
    function pieChart(measure) {
        var pieChart = measure.containers.pieChart.g
            .append('g')
            .selectAll('path')
    ...
    function pieText(measure) {
        var pieText = measure.containers.pieChart.g
            .append('g')
            .selectAll('text')
            .data(measure.pieData)
            .join('text')
    ...
    function draw(measure) {
        ...
        measure.arc = d3
            .arc() //.innerRadius(this.settings.widthPieChart/2 - 25)
            .innerRadius(0)
