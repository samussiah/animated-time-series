(function (global, factory) {
    ...
    function drawLines(measure) {
        var lines = measure.layout.timeSeries.lines
            .selectAll('line')
    ...
    function points(measure) {
        ...
        var points = measure.layout.timeSeries.points
            .selectAll('circle')
            .data(measure.ids, function (d) {
                return d[0];
            })
                ...
                return (
                    measure.xScale(
                        _this.util.getValue(
                            d[1],
                            'visit',
                            _this.timepoint.visit,
                            _this.settings.x_var
                        )
            ...
            .attr('cy', function (d) {
                return measure.yScale(
                    _this.util.getValue(d[1], 'visit', _this.timepoint.visit, _this.settings.y_var)
                );
            })
            .attr('r', 1)
            .attr('fill', measure.colorScale(0))
    ...
    function linesAggregate$1(measure) {
        ...
        var lines = measure.layout.timeSeries.linesAggregate
    ...
    function pointsAggregate$1(measure) {
        var points = measure.layout.timeSeries.pointsAggregate
            .append('circle')
            .datum(measure.aggregate)
    ...
    function layout$1(measure, key) {
        ...
        var timeSeries = this.util
            .addElement('time-series', main)
