(function (global, factory) {
    ...
    function update() {
        ...
        if (this.settings.var_labels.stratification === null)
            this.settings.var_labels.stratification = this.settings.stratification_var; // Update footnotes.
    ...
    function d(data) {
        ...
        var lineData = this.set.visit_order.map(function (visit_order, i) {
            ...
            if (visit_order >= _this.timepoint.visit_order) datum = _objectSpread2({}, latestVisit);
    ...
    function attr(measure, points) {
        ...
        points
            .attr('cx', function (d) {
                return (
                    measure.xScale(d[_this.settings.x_var]) +
        ...
        measure.linesAggregate
            ...
            .attr('x2', function (d, i) {
                return _this.settings.x_type === 'ordinal'
                    ? measure.xScale(_this.timepoint.visit) + measure.xScale.bandwidth() / 2
                    : measure.xScale(_this.timepoint.day);
            })
            .attr('y2', function (d) {
            ...
            measure.pointsAggregate
                ...
                .attr('fill', function (d, i) {
                    return measure.colorScale(
                        d[_this.timepoint.index][_this.settings.color_var === 'change' ? 2 : 3]
                    );
                });
        else
            measure.pointsAggregate
    ...
    function iterate() {
        ...
        if (this.settings.timepoint === 0) {
            ...
            (_this$interval = this.interval) === null || _this$interval === void 0
                ? void 0
                : _this$interval.stop();
            (_this$timeout = this.timeout) === null || _this$timeout === void 0
                ? void 0
                : _this$timeout.stop();
    ...
    function play(parent) {
        ...
        input.on('click', function (event, d) {
            ...
            (_main$timeout = main.timeout) === null || _main$timeout === void 0
                ? void 0
                : _main$timeout.stop();
            (_main$interval = main.interval) === null || _main$interval === void 0
                ? void 0
                : _main$interval.stop(); // Ensure timepoint is displayed.
    ...
    function group() {
        ...
        group.stratification_visit = create$1.call(this, 'stratification,visit');
    ...
    function data() {
        ...
        this.summary.forEach(function (stratum, i) {
            stratum[1].sort(function (a, b) {
                return _this.set.visit.indexOf(a[0]) - _this.set.visit.indexOf(b[0]);
            });
            stratum[1].forEach(function (visit, j) {
                ...
                _this.summary.tabular[i * _this.set.visit.length + j] = datum;
            });
        });
    ...
    function plot() {
        ...
        this.summary.forEach(function (stratum) {
            stratum.subset = stratum[1].slice(0, _this.settings.timepoint + 1);
        }); // layout

        var dimensions = getDimensions$1();
        var svg = getSvg(this.layout.charts, dimensions); // scales
        ...
        this.scales = {
            ...
            y: getYScale(
                [
                    0,
                    d3.max(this.summary.tabular, function (d) {
                        return d.value;
                    }),
                ],
                dimensions,
        ...
        var lines = plotLines.call(this, svg, this.summary, this.scales);
        var points = plotPoints.call(this, svg, this.summary, this.scales);
        var annotations = plotAnnotations.call(this, svg, this.summary, this.scales); // increment timepoint and update plot accordingly
        ...
        var iterate = function iterate() {
            ...
            if (this.settings.timepoint >= this.set.visit.length) {
                ...
                console.log(this.settings.timepoint);
                updateLines$1.call(this, lines, this.scales);
                updatePoints$1.call(this, points, this.scales);
